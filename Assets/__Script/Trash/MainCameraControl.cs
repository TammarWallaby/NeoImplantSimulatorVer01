...
public class MainCameraControl : MonoBehaviour
{
    ...
    public float maxRayDistance = 10f; // Ray의 최대 거리
    public LayerMask toolsLayer; // 상호작용할 레이어 (Tools)
    public LayerMask trayLayer;

    public Transform heldObject; // 쥐고 있는 오브젝트
    private Vector3 offset; // 오브젝트와 카메라 간의 오프셋

    public GameObject onTrayTools;
    public Vector3 toolsOriginalPosition;
